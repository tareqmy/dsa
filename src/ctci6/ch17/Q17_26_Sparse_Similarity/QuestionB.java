package ctci6.ch17.Q17_26_Sparse_Similarity;
...
import ctci6.commons.HashMapList;
...
public class QuestionB {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numDocuments; i++) {
			...
			ArrayList<Integer> w = ctci6.ch17.Q17_26_Sparse_Similarity.Tester.removeDups(words);
